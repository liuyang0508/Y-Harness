...
| Observability | content-free phase records, latency/outcome/accounting, exact integer provider-cost evidence, panic isolation, bounded collector, allocation-bounded JSONL | `src/observability`, ADRs 0017/0064/0083 | local baseline passing |
