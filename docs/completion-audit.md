...
The all-feature workspace run contains 513 passing Core library tests plus
3 manual size tests, 13 Domain Pack control-plane tests, 17 CLI configuration
tests, 26 Engine process/service tests, 18 TUI unit/render tests, 2 local
...
fault-fixture tests: 656 passing plus 8 explicitly ignored fixtures in total.
The no-default-feature workspace run contains 626 passing tests plus 4 ignored
...
State-14/Approval-3/Task-4/Workflow-1/Handoff-1/Effect-1/Effect-Executor-1/Temporal-2/Secret-3/Protocol-31 candidate; Cargo's
