...
3 manual size tests, 13 Domain Pack control-plane tests, 11 CLI configuration
...
fault-fixture tests: 514 passing plus 8 explicitly ignored fixtures in total.
The no-default-feature workspace run contains 484 passing tests plus 4 ignored
