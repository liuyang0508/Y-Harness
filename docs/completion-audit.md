...
tests, 28 Engine process/service tests, 17 TUI unit/render tests, 2 local
...
fault-fixture tests: 573 passing plus 8 explicitly ignored fixtures in total.
The no-default-feature workspace run contains 543 passing tests plus 4 ignored
