...
private-MCP TLS integration tests, 42 product/Engine evidence-adapter tests, and 6
deterministic fault-fixture tests: 440 passing plus 7 explicitly ignored
fixtures in total. The no-default-feature workspace run contains 411 passing tests plus 3 ignored
