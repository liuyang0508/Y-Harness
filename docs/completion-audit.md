...
The all-feature workspace run contains 391 passing Core library tests plus
...
fault-fixture tests: 516 passing plus 8 explicitly ignored fixtures in total.
The no-default-feature workspace run contains 486 passing tests plus 4 ignored
