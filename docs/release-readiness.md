...
| Distribution package | `cargo package --locked -p y-harness`, clean-room Core crate verification | passing locally with State-14, Approval-3, Task-3, Workflow-1, Handoff-1, Effect-1, embedded Effect-Executor-1/Effect-Dispatch-Governor-1/Temporal-2, Secret-3, and Protocol-30 coordinates; optional control-plane crate remains a separate workspace package |
