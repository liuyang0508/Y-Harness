...
| Distribution package | `cargo package --locked -p y-harness` clean-room Core crate verification | pending final size refresh; current coordinates are State-13, Approval-3, Task-2, Secret-2, and Protocol-24; optional control-plane crate remains a separate workspace package |
