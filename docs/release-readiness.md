...
| Deterministic tests | 436 Core library, 13 Domain Pack control-plane, 15 CLI, 28 Engine process/service, 18 TUI unit/render, 2 private-gateway TLS integration, 2 private-MCP TLS integration, 53 product/Engine evidence-adapter, and 7 fault-fixture tests | passing locally: 574 total plus 8 explicitly ignored manual/environment fixtures; zero-default workspace passes 544 plus 4 ignored |
