...
| Deterministic tests | 487 Core library, 13 Domain Pack control-plane, 17 CLI unit, 5 Protocol/CLI integration, 25 Engine process/service, 18 TUI unit/render, 2 private-gateway TLS integration, 2 private-MCP TLS integration, 53 product/Engine evidence-adapter, and 7 fault-fixture tests | passing locally: 629 total plus 8 explicitly ignored manual/environment fixtures; zero-default workspace passes 599 plus 4 ignored |
