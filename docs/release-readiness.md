...
| Deterministic tests | 513 Core library, 13 Domain Pack control-plane, 17 CLI unit, 5 Protocol/CLI integration, 26 Engine process/service, 18 TUI unit/render, 2 private-gateway TLS integration, 2 private-MCP TLS integration, 53 product/Engine evidence-adapter, and 7 fault-fixture tests | passing locally: 656 total plus 8 explicitly ignored manual/environment fixtures; zero-default workspace passes 626 plus 4 ignored |
...
| Distribution package | `cargo package --locked -p y-harness`, clean-room Core crate verification | passing locally with State-14, Approval-3, Task-4, Workflow-1, Handoff-1, Effect-1, embedded Effect-Executor-1/Effect-Dispatch-Governor-1/Temporal-2, Secret-3, and Protocol-31 coordinates; optional control-plane crate remains a separate workspace package |
