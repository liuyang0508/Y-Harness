...
| Deterministic tests | 391 Core library, 13 Domain Pack control-plane, 11 CLI, 24 Engine process/service, 11 TUI unit/render, 2 private-gateway TLS integration, 2 private-MCP TLS integration, 53 product/Engine evidence-adapter, and 7 fault-fixture tests | passing locally: 514 total plus 8 explicitly ignored manual/environment fixtures |
...
| Distribution package | `cargo package --locked -p y-harness`, 240-file / 3.3 MiB clean-room Core crate verification (731.6 KiB compressed) | passing locally with State-13, Approval-3, Task-3, Secret-2, and Protocol-25 coordinates; optional control-plane crate remains a separate workspace package |
