...
| Distribution package | `cargo package --locked -p y-harness`, clean-room Core crate verification | pending recheck with State-13, Approval-3, Task-3, Secret-2, and Protocol-25 coordinates; optional control-plane crate remains a separate workspace package |
