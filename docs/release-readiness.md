...
| Distribution package | `cargo package --locked -p y-harness`, clean-room Core crate verification | pending final package measurement with State-14, Approval-3, Task-3, Secret-2, and Protocol-26 coordinates; optional control-plane crate remains a separate workspace package |
