...
OpenCode fixed-output result, and two Codex CF-003 fault records. All have
...
3. ~~add OpenCode and Hermes Agent adapters without importing their code;~~
   ...
   real process-restart CF-003 record; Grok Build and Hermes remain
   contract-only;
...
locally fault-tested in Y-Harness. Five real released-product records, the
